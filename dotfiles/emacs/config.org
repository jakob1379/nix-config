...
#+PROPERTY: header-args :results silent :tangle ~/.emacs.d/config.el :cache yes :padline no
  ...
  (use-package company
    ...
    (setq company-backends
          '((company-capf company-dabbrev company-files company-keywords company-yasnippet)
            (company-clang company-cmake company-ispell)
    ...
    :hook
    (c++-mode . (lambda () (add-to-list 'company-backends 'company-clang)))
...
(use-package org-roam
  ...
  :custom
  (org-roam-directory "~/Documnets/RoamNotes")
...
(use-package dired
  ...
  :config
  ;; Basic dired customization
  ;; Add your custom settings or additional configurations here if needed
  )
...
(use-package dired-git-info
  ...
  :config
  ;; Optional: Add more configurations for dired-git-info here
  )
...
(use-package all-the-icons-dired
  ...
  :config
  ;; Optional: Add more configurations for all-the-icons-dired here
  )
